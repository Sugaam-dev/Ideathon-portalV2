...
// const CompactInput = ({ label, error, maxLength, ...props }) => (
//   <div className="relative pt-4 group">
//     <input
//       {...props}
//       maxLength={maxLength} // Correctly applying the limit here
//       className={`w-full bg-transparent border-b ${
//         error ? "border-red-500" : "border-[#2A3553]"
//       } py-2 text-sm text-[#E5E7EB] placeholder-transparent focus:border-cyan-400 outline-none transition-all peer`}
//       placeholder={label}
//     />
//     <label
...
//     // Optional fields don't need validation if empty
...
//     // Updated regex for backend E.164-like requirement
//     if (name === "phone" && !/^\+?[0-9]{10}$/.test(value)) 
//         error = "Enter a valid phone number";
    
//     if (name === "password") {
//       // Backend: Min 8, 1 Upper, 1 Digit, 1 Special
//       const regex = /^(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*(),.?":{}|<>]).{8,}$/;
//       if (!regex.test(value)) 
...
//               <button
//                 onClick={() =>
//                   dispatch(verifyRegistrationOtp(registeredEmail, otp.join("")))
//                 }
...
//     { label: "Phone Number *", key: "phone", maxLength: 10 }, // Fixed syntax here
//     { label: "Organization", key: "organization" },
//     { label: "Department", key: "department" },
//     { label: "LinkedIn URL", key: "linkedin", full: true },
//     { label: "Password *", key: "password", type: "password", full: true },
//     { label: "Confirm Password *", key: "confirm", type: "password", full: true },
//   ].map((field) => (
//     <div key={field.key} className={field.full ? "sm:col-span-2" : ""}>
//       <CompactInput
//         label={field.label}
//         type={field.type || "text"}
//         maxLength={field.maxLength} // Passing the maxLength prop here
//         value={form[field.key]}
//         onChange={(e) => {
//           if (field.key === "phone") {
//             const numericValue = e.target.value.replace(/[^0-9]/g, "");
//             setForm({ ...form, [field.key]: numericValue });
//           } else {
