...
// import { useAdminStats, useAdminPool } from '../../ideas/api/ideasApi';
// import { formatDate } from '../../../utils/formatters';
// import { CATEGORIES } from '../../../config/constants';
// import { Search, BarChart3, Users, Lightbulb, CheckCircle2, ShieldAlert } from 'lucide-react';
...
//                 {submissions.map((sub) => (
//                   /* KEY UPDATE: Including the score in the key forces a re-render 
//                      whenever the score changes for this specific idea row. */
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-6 py-8 flex-1 space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {/* Tab Selection */}
        <div className="flex bg-slate-100 p-1.5 rounded-xl border border-slate-200 shrink-0 self-start sm:self-auto">
          <button 
